...
public class LinkElmByTextLookUp extends By {

	private final String label;

	public LinkElmByTextLookUp(String label) {
		this.label = label;
	}
	...
	private String createLinkLookupQuery(String label, SearchContext ctx) {
		...
		return ".//a[contains(" + ElementInspector.toLowerCaseXpathQuery("text()") + ",'" + trimmedLabel.toLowerCase() + "')]";
	}
