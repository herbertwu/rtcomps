...
public class DoubleClickElementAction extends WebActionsBase {
	protected static final Logger logger =  LoggerFactory.getLogger(DoubleClickElementAction.class);
	private String id;
	private String name;
	...
	public DoubleClickElementAction(@Param(name = "id")String id, 
	...
	public ActionRunResult execute() {
		try {
			...
			getBrowser().doubleClick(attributes);
			
			logger.info("doubleClickElement params=" + attributes);
